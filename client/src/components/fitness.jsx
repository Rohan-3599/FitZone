...
const photos = [
 ...
 class Fitness extends Component {
    ...
    const { name ,email , phone} = this.state
     const sub = await  axios.post('/api/submit',{
        name,
        email,
        phone
    }).then(
        alert("Taking You to Join Page"),
        this.reset(),
    )
      }
 reset(){
 ...
 <p>Dont be afraid to Book your first class.</p>
                    ...
                    <div className="col-lg-6">
                        <div className="booking-form">
                            <form  name="join" onSubmit={this.Submit} method="POST">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <input type="text"  placeholder="Your Name" value={this.state.name} onChange={this.InputName} required></input>
                                        <input type="text"  placeholder="Your Phone" value={this.state.phone} onChange={this.InputPhone} required></input>
                                    </div>
                                    <div className="col-lg-6">
                                        <input type="email"  placeholder="E-mail Address"  value={this.state.email} onChange={this.Inputemail} required></input>
