...
search(){
            ...
            <div className="row">
                <div className="col-lg-3 col-sm-6">
                    <div className="about-single-counter">
                     ...
                     <span ><CountUp  className="counter-num counter" end={245} duration={5} /></span>
                            <span>Members</span>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-sm-6">
                    <div className="about-single-counter">
                        ...
                        <div className="counter-text">
                            <span><CountUp  className="counter-num counter" end={38} duration={6} /></span>
                ...
                <div className="col-lg-3 col-sm-6">
                    <div className="about-single-counter">
                        ...
                        <div className="counter-text">
                        <span><CountUp  className="counter-num counter" end={16} duration={6} /></span>
                ...
                <div className="col-lg-3 col-sm-6">
                    <div className="about-single-counter">
                        ...
                        <div className="counter-text">
                        <span><CountUp  className="counter-num counter" end={125} duration={5} /></span>
    ...
    <section className="about-team spad" id="about-team">
        <div className="container">
          ...
          <i className="fa fa-facebook fa-fw"></i> Follow On Facebook
        </a>
        <a href="#" className="twitter btn">
          <i className="fa fa-twitter fa-fw"></i> Follow On Twitter
        </a>
        <a href="#" className="google btn">
          <i className="fa fa-google fa-fw"></i> Follow On Google+
        </a></div>  
                            <img src={member}  alt=""/>
                        </div>
