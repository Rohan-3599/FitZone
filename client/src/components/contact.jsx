...
const form= await axios.post('/api/form',{
    ...
    this.state.success = 'Message Sent Successfully!',
    setTimeout(() => {
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-8">
                    <form onSubmit={this.handleSubmit} name="contact" className="contact-form" method="POST">
                        <div className="row">
                            <div className="col-lg-6">
                                <input type="text" name="name" placeholder="Your Name" onChange={this.handleInputName} value={this.state.name} required />
                            </div>
                            <div className="col-lg-6">
                                <input type="email" name="email" placeholder="Your E-mail" onChange={this.handleInputemail}  value={this.state.email} required/>
                            </div>
                            <div className="col-lg-12">
                                <input type="text" name="subject" placeholder="Subject" onChange={this.handleInputsubject} value={this.state.subject} required/>
                                <textarea placeholder="Message" name="message" onChange={this.handleInputmessage} value={this.state.message} required></textarea>
                                <input type="submit" className="submit-btn contact-btn" value="Send" />
                                <div className="success-wrap"><p className="success-msg">{this.state.success}</p></div>
                            </div>
                        </div>
                    </form>
                </div>
